...
class ReactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reaction" do
    assert_difference('Reaction.count') do
      post reactions_url, params: { reaction: { user_id: @reaction.user_id, user_skill_id: @reaction.user_skill_id } }
    end
  ...
  test "should update reaction" do
    patch reaction_url(@reaction), params: { reaction: { user_id: @reaction.user_id, user_skill_id: @reaction.user_skill_id } }
